...
# 本を元に戻す
item replace entity @s weapon.mainhand with writable_book[enchantment_glint_override=true,custom_data={gui_maker:{editor_item:5b}},item_name="Tıklama Sesi Fonksiyon Kaydı",lore=[{"color":"white","italic":false,"text":"İkinci eldeki eşyaya tıklandığında çalışacak fonksiyonu atar."},{"color":"white","italic":false,"text":"Kitap içine yazılan yol, çalıştırılacak fonksiyon (function) olur."}]] 1
