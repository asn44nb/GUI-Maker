...
# 本を元に戻す
item replace entity @s weapon.mainhand with writable_book[enchantment_glint_override=true,custom_data={gui_maker:{editor_item:6b}},item_name="Sayfa Etiketi Kaydı",lore=[{"color":"white","italic":false,"text":"Mevcut sayfanın etiket adını belirler."},{"color":"white","italic":false,"text":"Kitap içine yazılan metin, sayfanın etiketi olur."}]] 1
